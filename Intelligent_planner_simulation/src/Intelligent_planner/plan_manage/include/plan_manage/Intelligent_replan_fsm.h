...
// which charges the several states in the planning process.
    ...
    private:
        ...
        std::vector<Eigen::Vector3d> mpc_traj_pos_, mpc_traj_vel_, mpc_traj_acc_, mpc_traj_jerk_;
        ...
        std::vector<Eigen::Vector3d> ego_history_pos_,ego_history_vel_,ego_history_opt_pos_,ego_history_opt_vel_;
        std::vector<Eigen::Vector3d> ego_pos_, ego_vel_,ego_opt_pos_,ego_opt_vel_;
        ...
        ros::Publisher pos_cmd_pub_, pos_cmd_vis_pub_, exected_traj_pub_, ego_traj_pub_, ego_opt_pub_;
        ...
        //
        void draw_traj_ego();
        void draw_history_traj_ego();
        void draw_opt_ego();
        void displayOptimalList(vector<Eigen::Vector3d> list, int id);
        void displayMarkerList(ros::Publisher &pub, const vector<Eigen::Vector3d> &list, double scale, Eigen::Vector4d color, int id);
        //
