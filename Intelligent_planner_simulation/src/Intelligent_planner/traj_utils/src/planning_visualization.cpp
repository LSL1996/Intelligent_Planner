...
PlanningVisualization::PlanningVisualization(ros::NodeHandle& nh){
    ...
    pos_cmd_pub_            = node.advertise<visualization_msgs::Marker>("/planning_vis/pos_cmd_vis",20);             // 3
    pubs_.push_back(pos_cmd_pub_);

    exected_traj_pub_       = node.advertise<visualization_msgs::Marker>("/travel_traj", 20);                         // 4
