...
private:
    ...
    ros::NodeHandle node;
    ros::Publisher  mpc_traj_pub_, mpc_traj_ref_pub_, pos_cmd_pub_, exected_traj_pub_, local_goal_pub_,high_mpc_traj_pub_;
...
public:
    ...
    void drawHighMpcTraj(const vector<Eigen::Vector3d>& traj, double resolution,const Eigen::Vector4d& color, int id = 0);
