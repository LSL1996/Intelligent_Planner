...
namespace Intelligent_planner{
    ...
    private:
        ...
        Eigen::Vector3d A_external_force_, external_force_remain_;
        ...
        double f_;
        Eigen::VectorXd input_x_, input_y_, input_z_, input_f_;// input (snap)
        Eigen::VectorXd state_x_, state_y_, state_z_;  // state of mpc system and reference theta system
        Eigen::Vector3d map_min_, map_max_;
        Eigen::VectorXd Gradient_x_, Gradient_y_, Gradient_z_, Gradient_f_;
